...
public class RecordedSimulationMyntra extends Simulation {

  {
    ...
    ScenarioBuilder scn = scenario("RecordedSimulationMyntra")
      .exec(
        http("request_0")
          .get(uri22 + "/")
          .headers(headers_0)
          .resources(
            ...
            http("request_6")
              ...
              .headers(headers_6)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0006_request.json")),
            http("request_7")
              .post(uri22 + "/beacon/user-data")
              .headers(headers_7)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0007_request.json")),
            http("request_8")
              .post(uri22 + "/gateway/v1/user/locationContext")
              .headers(headers_8)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0008_request.json")),
            http("request_9")
              .post(uri13 + "?key=AIzaSyA65lEHUEizIsNtlbNo-l2K18dT680nsaM")
              .headers(headers_9)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0009_request.json")),
            http("request_10")
            ...
            http("request_15")
              ...
              .headers(headers_9)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0015_request.json")),
            http("request_16")
            ...
            http("request_23")
              .post(uri11)
              .headers(headers_23)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0023_request.json")),
            http("request_24")
              .post(uri11)
              .headers(headers_23)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0024_request.json")),
            http("request_25")
              .get(uri44 + "/gtag/js?id=DC-8758799")
              .headers(headers_1),
            http("request_26")
            ...
            http("request_54")
              .post(uri51)
              .headers(headers_54)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0054_request.json")),
            http("request_55")
            ...
            http("request_57")
              .post(uri59)
              .headers(headers_57)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0057_request.bin")),
            http("request_58")
            ...
            http("request_64")
              .post(uri62)
              .headers(headers_64)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0064_request.json")),
            http("request_65")
            ...
            http("request_76")
              ...
              .headers(headers_76)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0076_request.json")),
            http("request_77")
      ...
      .exec(
        http("request_92")
          .post(uri11)
          .headers(headers_23)
          .body(RawFileBody("gatling/recordedsimulationmyntra/0092_request.json"))
      )
      .pause(1)
      .exec(
        http("request_93")
          ...
          .resources(
            ...
            http("request_98")
              ...
              .headers(headers_98)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0098_request.json")),
            http("request_99")
              .get(uri22 + "/wishlist")
              .headers(headers_99),
            http("request_100")
            ...
            http("request_105")
              .post(uri22 + "/beacon/user-data")
              .headers(headers_7)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0105_request.json")),
            http("request_106")
              .get(uri44 + "/gtm.js?id=GTM-H34B")
              .headers(headers_10),
            http("request_107")
              .post(uri11)
              .headers(headers_23)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0107_request.json")),
            http("request_108")
        ...
        http("request_150")
          ...
          .resources(
            ...
            http("request_162")
              .post(uri22 + "/beacon/user-data")
              .headers(headers_7)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0162_request.json")),
            http("request_163")
              .get(uri39 + "/embed/cbeJWezqKiM")
              .headers(headers_160)
          )
        ...
        http("request_164")
          ...
          .resources(
            ...
            http("request_169")
              .post(uri28 + "/Create")
              .headers(headers_169)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0169_request.dat")),
            http("request_170")
              .get(uri22 + "/gateway/v1/cart/default/summary")
              .headers(headers_13),
            http("request_171")
            ...
            http("request_172")
              .post(uri11)
              .headers(headers_23)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0172_request.json")),
            http("request_173")
              .post(uri11)
              .headers(headers_23)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0173_request.json")),
            http("request_174")
              .get(uri02 + "?a=34567"),
            http("request_175")
              .get(uri44 + "/gtag/js?id=DC-8758799"),
            ...
            http("request_187")
              ...
              .headers(headers_169)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0187_request.dat")),
            http("request_188")
              .get(uri12 + "/1535206906706865?v=2.9.84&r=stable")
              .headers(headers_1),
            http("request_189")
            ...
            http("request_212")
              .post(uri59)
              .headers(headers_57)
              .body(RawFileBody("gatling/recordedsimulationmyntra/0212_request.bin"))
          )
      )
      .pause(1)
      .exec(
        http("request_213")
          ...
          .headers(headers_213)
          .body(RawFileBody("gatling/recordedsimulationmyntra/0213_request.json"))
      )
      .pause(4)
      .exec(
        http("request_214")
          ...
          .headers(headers_214)
          .body(RawFileBody("gatling/recordedsimulationmyntra/0214_request.json"))
      )
      .pause(3)
      .exec(
        http("request_215")
